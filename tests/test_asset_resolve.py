...
def test_resolve_exam_asset_reads_from_db(monkeypatch) -> None:
    ...
    asset = exams_module._resolve_exam_asset_payload("common-test-2025", "assets/q15.png")
...
def test_resolve_exam_asset_returns_none_for_invalid_or_missing_asset(monkeypatch) -> None:
    ...
    assert exams_module._resolve_exam_asset_payload("common-test-2025", "..\\app.py") is None
    assert exams_module._resolve_exam_asset_payload("common-test-2025", "assets/../../app.py") is None
    assert exams_module._resolve_exam_asset_payload("common-test-2025", "assets\\..\\..\\app.py") is None
    ...
    spec = exams_module.build_render_ready_public_spec(
        {
            ...
            "end_image": "/exams/demo/assets/assets/thanks.png",
            "questions": [{"qid": "Q1", "stem_md": "题干 **加粗**"}],
        }
    )

    assert spec["welcome_image"] == "/exams/demo/assets/assets/welcome.png"
    assert spec["end_image"] == "/exams/demo/assets/assets/thanks.png"
